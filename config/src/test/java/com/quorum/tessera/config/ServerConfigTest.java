...
public class ServerConfigTest {
    ...
    public void bindingUriInvalidUri() {
        new ServerConfig(AppType.P2P, true, "&@€~:*&2:-1", CommunicationType.REST, null, null, "&@€~:*&2:").getBindingUri();
    }
    ...
    public void advertisedUrlIsDifferentToBindAddress() {
        final ServerConfig serverConfig = new ServerConfig(AppType.P2P, true, "somedomain:8989", CommunicationType.REST, null, null, "http://bindingUrl:9999");
